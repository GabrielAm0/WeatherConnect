...
function Slogan() {
	return (
	 <section className="bg-white dark:bg-slate-800 py-10 cel:pb-1">
		 <div className="flex items-center justify-center flex-wrap mx-auto">
			 <div className="container">
				 <div className="relative max-w-5xl mx-auto pt-20 sm:pt-24 lg:pt-32">
					 <div className="flex flex-col items-center">
						 <h1 className="text-slate-900 dark:text-white font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight text-center relative z-10">
					 ...
					 <p className="mt-6 cel:mt-20 text-lg text-slate-900 dark:text-slate-200 text-center max-w-3xl mx-auto">
