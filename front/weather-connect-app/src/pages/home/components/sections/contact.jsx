...
function Contact() {
	...
	return (<>
		 ...
		 <section className="bg-white dark:bg-slate-900 text-gray-700 body-font relative">
			 <div  id="contact" className="container px-5 pb-36 max-[414px]:pb-15 mx-auto">
				 ...
				 <div className="lg:w-1/2 md:w-2/3 mx-auto">
					 <div className="flex flex-wrap -m-2">
						 ...
						 <div className="p-2 w-full ">
							 <button
							  className="flex mx-auto text-white bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg text-center">
								 Enviar
							 </button>
